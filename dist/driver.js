import { Component, Dynamic, State } from "./index.js";
        ...
        const HandleComponentProperties = (el, properties) => {
            for (let key of Object.keys(properties)) {
                if (properties[key] == "__ignore__" || properties[key] == undefined)
                    continue;
                if (key == "children" || key == "child" || key == "__driver__" || key == "reference" || key == "ondestroy")
                    continue;
                switch (key) {
                    case "style":
        ...
        if (typeof (component) == "function") {
            ...
            const DetectChanges = () => {
                ...
                if (DynamicComponent == null) {
                    const temp = this.BuildDOMTree(callback);
